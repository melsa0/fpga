set project_name "switch_oled"
set project_dir "C:/switch_oled_build"
...
add_files -fileset constrs_1 -norecurse "$script_dir/nexys_video_sw_oled.xdc"
set_property top switch_oled_top [current_fileset]
...
puts "========== PROGRAMMING =========="
set bitstream_file "$project_dir/$project_name.runs/impl_1/switch_oled_top.bit"
