...
add_files -fileset constrs_1 -norecurse "$script_dir/nexys_video_pong.xdc"
...
puts "========== PROGRAMMING =========="
set bitstream_file "$project_dir/$project_name.runs/impl_1/pong_top.bit"
